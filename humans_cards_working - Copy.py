"""
Data set from: http://vision.stanford.edu/Datasets/40actions.html  --for human photos
https://www.kaggle.com/datasets/gunhcolab/object-detection-dataset-standard-52card-deck   --for cards
...
class HumanCards(Dataset):
    # load the dataset definitions
    def load_dataset(self, dataset_dir, is_train=True):
        # define classes
        self.add_class("dataset", 1, "person")
        self.add_class("dataset", 2, "cards")
    ...
    def load_mask(self, image_id):
        ...
        for i in range(len(boxes)):
            ...
            if (box[4] == 'person'):
                ...
                class_ids.append(self.class_names.index('cards')) 
...
# train set
dataset_dir="C:/Users/kavya/Downloads/humans and cards/dataset"

train_set = HumanCards()
...
model.load_weights("C:/Users/kavya/Downloads/humans and cards/weights/mask_rcnn_coco.h5", by_name=True, exclude=["mrcnn_class_logits", "mrcnn_bbox_fc",  "mrcnn_bbox", "mrcnn_mask"])
...
# load model weights
model.load_weights('logsmask_rcnn_humancards_cfg_0020.h5', by_name=True)
...
fruit_img = skimage.io.imread("C:/Users/kavya/Downloads/humans and cards/dataset/212.jpg")
detected = model.detect([fruit_img])[0] 


pyplot.imshow(fruit_img)
ax = pyplot.gca()
class_names = ['person', 'cards']
class_id_counter=1
